...
<nav class="navbar navbar-default hidden-md hidden-lg hidden-sm" >
	...
	<div  class="container">
		...
		<hr />
		<ol class="breadcrumb">
		   <li> Go back to <span class="label label-primary"><a style="color:#FFFFFF;" href="./" >Blog Index</a></span></li>
		</ol>
        ...
        <div class="panel panel-danger">
			 <div class="panel-heading">
				 <div class="page-header">	
					<?php	
							echo '<h1 style="font-family: Georgia, "Times New Roman", Times, serif;">'.$row['postTitle'].'</h1>';
					?>
				 </div>
			 </div>
