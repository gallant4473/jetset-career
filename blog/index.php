...
<nav class="navbar navbar-default hidden-md hidden-lg hidden-sm" >
	...
	<div class="container">
		...
		<h1 style="font-family: Georgia, "Times New Roman", Times, serif;">Blog</h1>
		<hr />
					...
					<div class="panel panel-danger">
						  <div class="panel-heading">
								<div class="page-header">	
									<?php				
									echo '<h1 ><a style="color:black; font-family: Georgia, "Times New Roman", Times, serif;" href="viewpost.php?id='.$row['postID'].'">'.$row['postTitle'].'</a></h1>';
									?>
								</div>
						  </div>
						  <div class="panel-body" >	
							  ...
							  <?php 
								...
								echo '<cite title="Source Title"><a href="viewpost.php?id='.$row['postID'].'">Read More</a></cite>';				
							  ?>
							 </blockquote>
						  </div>
						  <div class="panel-footer">
							  <?php 
								echo '<blockquote class="blockquote"><footer style="text-align:right;">Posted on <cite title="Source Title">'.date('jS M Y H:i:s', strtotime($row['postDate'])).'<cite></footer></blockquote>';
							  ?>
						   </div>
				</div>  	  
				<?php
